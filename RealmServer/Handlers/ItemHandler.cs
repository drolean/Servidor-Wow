...
namespace RealmServer.Handlers
{
    ...
    {
        public SmsgItemQuerySingleResponse(int item) : base(RealmCMD.SMSG_ITEM_QUERY_SINGLE_RESPONSE)
        {
    ...
    internal class ItemHandler
    {
        internal static void OnItemQuerySingle(RealmServerSession session, PacketReader handler)
        {
            ...
            session.SendPacket(new SmsgItemQuerySingleResponse((int) itemId));
        }
    }
